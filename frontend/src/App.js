...
function SeatSelection() {
  ...
  useEffect(() => {
    axios.get('https://order-orders.apps.cluster-n9mp9.n9mp9.sandbox2169.opentlc.com/orders/users')
    ...
    axios.get('https://allocate-allocations.apps.cluster-n9mp9.n9mp9.sandbox2169.opentlc.com/seats')
      .then(response => {
  ...
  const handlePayment = async () => {
    ...
    try {
      const response = await axios.post('https://order-orders.apps.cluster-n9mp9.n9mp9.sandbox2169.opentlc.com/orders', {
        seatId: selectedSeat,
        userId: selectedUser,
        price: price
      });
      ...
      const updatedSeats = await axios.get('https://allocate-allocations.apps.cluster-n9mp9.n9mp9.sandbox2169.opentlc.com/seats');
