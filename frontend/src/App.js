...
function SeatSelection() {
  ...
  useEffect(() => {
    axios.get('https://order-orders.apps.gey8rivy.eastus.aroapp.io/users')
    ...
    axios.get('https://allocate-allocations.apps.gey8rivy.eastus.aroapp.io/seats')
      .then(response => {
  ...
  const handlePayment = async () => {
    ...
    try {
      const response = await axios.post('https://order-orders.apps.gey8rivy.eastus.aroapp.io/order', {
        seatId: selectedSeat,
        userId: selectedUser,
        price: price
      });
      ...
      const updatedSeats = await axios.get('https://allocate-allocations.apps.gey8rivy.eastus.aroapp.io/seats');
